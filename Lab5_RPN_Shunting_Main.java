...
import solutions.pack5.*;

public class Lab5_RPN_Shunting_Main {
    static void task1() {
        MyStackA_661277 stack = new MyStackA_661277();
        stack.push(1.0);
        stack.push(2.2);
        stack.push(4.4);
        stack.push(3.3);
    ...
    static void task2(String postfixString) {
        ...
        System.out.println("= " + MyRPN_661277.computeRPN(postfixString));
    ...
    public static void computeInfix(String infixString) {
        String postfixString = MyShuntingYard_661277.infixToPostfix(infixString);
        double ans = MyRPN_661277.computeRPN(postfixString);
